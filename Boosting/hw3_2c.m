...
Index=zeros(1500,1036);


for t = 1:1500
    
    %Bootstrap    
    Index(t,:) = randsample(1:1036,1036,true,w_boot);
    X_train_boot = X_train(Index(t,:),:);
    y_train_boot = y_train(Index(t,:),:);
...
% Plot the histogram of all Bt
histogram(Index,1036);