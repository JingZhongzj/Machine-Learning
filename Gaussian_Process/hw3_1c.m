...
%Find the smallest RMSE among the 60 values
RMSE_min = min(min(RMSE));

%Find the indexs of the minimum value
[M,I] = min(RMSE(:));
[I_row, I_col] = ind2sub(size(RMSE),I);
index_b = b(I_row);
index_sig2 = sig2(I_col);

T = table(RMSE_min,index_b,index_sig2);
T
